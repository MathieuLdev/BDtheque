...
const affichageBd = () => {
    ...
    const bdInsert = "<div class=un-album>" + "<div class='info'>" + "<div class='serie'>" + serie.nom + "</div>" + "<div class='album'>" + "Album n° : " + album.numero + "</div>" + "<div class='titre'>" + "Titre : "+ album.titre + "</div>" + "<div class='auteur'>" + "Auteur : " + auteur.nom + "</div>" + "<div class='prix'>" + album.prix  + " €" + "</div>" + "</div>" + '<img class="miniImg" src="./assets/albumsMini/' + monImg + ".jpg" + '"' + ">" + '<input type="button" id="ajoutPanier" name=' + key + ' value="">' + "</div>";
